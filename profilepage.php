	...
	<body>
		...
		<div id="editModal" style="display:none;" class="modal">
			<div class="modal-content">
				...
				<form id="profileForm" method="POST" action="/eiganights/update_profile.php" enctype="multipart/form-data">
					<label style="color:black">Username: 
						<input type="text" name="username" value="<?php echo htmlspecialchars($user['username']); ?>" required>
					</label><br><br>

					<label style="color:black">Upload New Avatar: 
						<input type="file" name="avatar" id="avatarInput" accept="image/*" onchange="updateAvatarPreview()">
					</label><br><br>

					<img id="avatarPreview" src="<?php echo htmlspecialchars($user['avatar']); ?>" alt="Avatar" style="width:100px;height:100px;"><br><br>
